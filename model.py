...
class Model(object):
    ...
    def dk(self):
        ...
        rotation_speed = (self.m1.speed - self.m2.speed) / self.1
    ...
    def update(self, dt):
       ...
       if rotation_speed == 0:
           ...
           dtheta = 0
            ...
            alpha = rotation_speed * dtheta
            dx = 1 * math.sin(alpha) / alpha
            dy = 1 * (math.cos(alpha) - 1) / alpha

        # Updating the robot position
        self.x = self.x + dx * math 
